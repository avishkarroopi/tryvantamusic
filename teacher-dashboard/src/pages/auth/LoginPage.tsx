...
/**
 * Standalone mock login screen. Not wired to a real identity provider —
 * this is the seam where Muziclly authentication (SSO / OTP / password)
 * plugs in later. Submitting simply lands on the dashboard.
 */
      ...
      <div className="w-full max-w-sm">
        <div className="mb-8 flex flex-col items-center gap-3 text-center">
          ...
          <div>
            ...
            <p className="text-xs font-medium text-ink-400 dark:text-ink-500">Teachers Dashboard</p>
          </div>
        </div>
