...
export function MessagesPage() {
  ...
  useEffect(() => {
    ...
    // Opening a conversation clears its unread badge, same as a real chat UI.
  ...
  return (
    <div>
      <PageHeader title="Chat With Students" description="Message students and guardians about upcoming classes." />

      <div className="grid grid-cols-1 overflow-hidden rounded-2xl border border-ink-100 bg-white shadow-card dark:border-ink-800 dark:bg-ink-900 md:grid-cols-[18rem_1fr]" style={{ height: "70vh" }}>
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center justify-between gap-2">
                      <p className="truncate text-sm font-semibold text-ink-900 dark:text-white">{c.studentName}</p>
                      {c.unreadCount > 0 && (
          ...
          {!activeChannel ? (
            ...
            <>
              <div className="flex items-center gap-3 border-b border-ink-100 p-3.5 dark:border-ink-800">
                ...
                <Avatar name={activeChannel.studentName} size="sm" />
                <div>
                  <p className="text-sm font-semibold text-ink-900 dark:text-white">{activeChannel.studentName}</p>
              ...
              <div className="flex-1 space-y-3 overflow-y-auto p-4">
                {messagesLoading ? (
                  ...
                  messages.map((m) => (
                    <div key={m.id} className={cn("flex flex-col", m.sender === "teacher" ? "items-end" : "items-start")}>
                      <div
                        className={cn(
