        ...
        <div className="relative" ref={menuRef}>
          ...
          >
            ...
            <span className="hidden text-left text-sm leading-tight sm:block">
              <span className="block font-semibold text-ink-900 dark:text-white">{teacher.name}</span>
              <span className="block text-xs text-ink-400 dark:text-ink-500">Teacher</span>
            </span>
