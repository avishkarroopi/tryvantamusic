...
export default function Reviews() {
  // The marquee content is duplicated once so the CSS `translateX(-50%)`
  // loop (Reviews.module.css `@keyframes scroll`) is seamless, exactly as
    ...
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <p className={styles.subtitle}>
          Real stories from parents and students who transformed their musical journey with us.
        </p>
      </div>
      ...
      <div className={styles.marqueeWrapper}>
        ...
        <div className={styles.trustBadge}>
          ...
          <span className={styles.ratingText}>Based on 39+ reviews</span>
        </div>
      </div>
    </div>
  );
