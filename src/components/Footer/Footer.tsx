        ...
        <div className={styles.grid}>
          <div className={styles.brand}>
            ...
            <p className={styles.tagline}>
              ...
              <br />
              Real Mentorship. Lasting Skill.
            </p>
            <div className={styles.socials}>
              <a
                href="https://www.facebook.com/muziclly.global"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/muzicllyglobal?igsh=cGNlbHduMTdqemd4&utm_source=qr"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://youtube.com/@muzicllyglobal?si=VLNcv4BRE3wPWUsT"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="YouTube"
                className={styles.socialLink}
              ...
              <a
                href="https://www.linkedin.com/company/muziclly/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className={styles.socialLink}
          ...
          <div className={styles.column}>
            ...
            <ul className={styles.linkList}>
              ...
              <li>
                <Link href="/forum-hub">Forum Hub</Link>
              </li>
              <li>
                <a href="mailto:hello@muziclly.com">Talk to Us</a>
              </li>
            </ul>
          </div>
          ...
          <div className={styles.column}>
            ...
            <ul className={styles.linkList}>
              ...
              <li>
                <span className={styles.textMuted}>Mon-Sat: 9AM - 8PM</span>
              </li>
            </ul>
          </div>
        </div>
