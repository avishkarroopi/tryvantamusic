...
const FAQS = [
  {
    ...
    a: "Go to Live Classroom, find your batch, and click \"Join Live Classroom\". If your teacher hasn't started the class yet, you'll see a waiting screen that joins automatically once they do.",
  },
  {
    q: "How do I log practice time?",
    a: "Open My Classes and click \"Log practice time\" on any class card. Your streak on the Dashboard updates automatically.",
  },
  {
    q: "How do I message my teacher?",
    a: "Go to Messages, pick a conversation with your teacher, and type your message. They'll be notified and can reply from their dashboard.",
  },
  {
    q: "How do I register for a Masterclass or Open Mic?",
    a: "Open Masterclass or Open Mic from the Community section and click \"Register\" or \"Reserve a slot\" on any event.",
  },
  {
    q: "Can I download sheet music and practice sheets?",
    a: "Yes — open Resource Library to browse everything your teachers have shared with you, organized by instrument.",
  },
];
        ...
        <div className="space-y-4">
          ...
          <Card>
            <CardBody className="space-y-3">
              ...
              <p className="text-sm text-ink-500 dark:text-ink-400">students-support@muziclly.app</p>
            </CardBody>
          </Card>
          <Card>
            <CardBody className="space-y-3">
              ...
              <p className="font-display font-semibold text-ink-900 dark:text-white">Talk to your teacher</p>
              <p className="text-sm text-ink-500 dark:text-ink-400">Reach out any time from Messages.</p>
            </CardBody>
          </Card>
        </div>
      </div>
